...
#include "include/mdns_private.h"
#include "include/mdns_networking.h"
#include "esp_log.h"
...
// -- API to create new MDNS instance
...
// -- API to find existing service
void find_mdns_service(const char * service_name, const char * proto,  mdns_result_t * results)
{
